...
\section{Poisson arrivals}

Recall from last session we discussed the following equivalence (and proved
one direction of the equivalence as an exercise):
...
\begin{enumerate}[label = (\alph*)]
  ...
  \item The probability that first customer arrives before 8:30am.
