...
\begin{document}
\lecture{2}{Random variables}{Bryan Liu}{runjing\_liu@berkeley.edu}{2}
...
\begin{example}(Stock prices)
  ...
  The probability that the change lands between two numbers $l$ and $u$ is modeled
  as
  \begin{align}
...
\fbox{\begin{minipage}{\textwidth}
Let $\mu = \E(X)$. The \textit{variance} of a random variable $X$, abbreviated
